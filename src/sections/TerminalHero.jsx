...
import AudioEngine from "../terminal-hero/audio.js";
import { COMMANDS, HEADER_ASCII } from "../terminal-hero/commands.js";
import PixelAvatar from "../terminal-hero/robot.jsx";
import TelemetryBar from "../terminal-hero/telemetry.jsx";
...
export default function TerminalHero() {
  ...
  return (
    <section
      id="boot"
      className="h-screen w-full flex flex-col p-4 md:p-6 crt-text relative z-10 snap-start shrink-0 overflow-hidden"
    >
      <header
      ...
      <div className="absolute bottom-2 left-1/2 -translate-x-1/2 text-[10px] text-gray-500 font-mono animate-pulse pointer-events-none">
        ↓ scroll down for recruiter view
      </div>
    </section>
  );
}
